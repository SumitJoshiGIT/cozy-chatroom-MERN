...
const ChatDialogComponent = React.memo(function ({}) {
  ...
  return (
    <div className="h-screen pb-3 pt-3">
      <div style={style==1?{width:'fit-content',padding:'1px',minWidth:'20px'}:{...position}} className="h-full w-sm max-w-sm p-4  flex-col  border-gray-300 shadow-xl   w-full overflow-hidden transition-2s  rounded-e-2xl gradient-2  z-10">
